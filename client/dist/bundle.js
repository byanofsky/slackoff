...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client__ = __webpack_require__(22);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(() => {
  ...
  const socket = io();
  const $messagesNode = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#messages');
  const $messagesWrapperNode = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#messages-wrapper');
  const $messageFormNode = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message-form');
  const $messageFormWrapper = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message-form-wrapper');

  function getMessages() {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get('/messages')
      .done((data) => {
  ...
  function handleSubmit() {
    ...
    // Reset message field
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.message).val('');
    return false;
  }
  ...
  socket.on('new message', (msgObjStr) => {
    ...
    $messagesNode.append(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(formatMessage(msgObj)));
    scrollMessages();
  });
